// Import Firebase modules from the CDN (version 11.3.1)
...
// Sample card database (customize as needed)
let cardDatabase = [
  // #1
...
// Save user data (collection & decks) to Firestore under the user's document.
...
// For this demo, if no user is signed in, sign in anonymously.
